...
"""
Produces a csv file sum of dot product from a functional connectivity file <func>,
efield file <efield>, and vertex area file <va>
Usage:
   meants_dotproduct [options] <func> <L_va> <R_va>
Arguments:
...
def main():
    parser = argparse.ArgumentParser(description="Run Mean dotproduct")
    parser.add_argument(
        "conn_map",
        type=str,
    ...
    if conn_map.shape != va_map.shape:
        logger.info("The number of vertices do not match")
        sys.exit()
    else:
